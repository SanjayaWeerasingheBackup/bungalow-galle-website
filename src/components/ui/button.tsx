...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-soft hover:shadow-elegant rounded-sm",
        ...
        hero: "bg-primary-foreground/10 text-primary-foreground border border-primary-foreground/30 backdrop-blur-sm hover:bg-primary-foreground/20 hover:border-primary-foreground/50 rounded-sm",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-glow rounded-sm",
        elegant: "bg-espresso text-cream hover:bg-espresso/90 tracking-widest uppercase text-xs rounded-sm",
      },
      size: {
